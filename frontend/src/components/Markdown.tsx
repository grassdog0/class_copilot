...
export function Markdown({ content, className }: { content: string; className?: string }) {
  return (
    <div
      className={cn(
        "markdown text-sm leading-relaxed text-slate-800",
        "[&_h1]:mt-3 [&_h1]:mb-2 [&_h1]:text-base [&_h1]:font-semibold [&_h1]:text-slate-900",
        "[&_h2]:mt-3 [&_h2]:mb-2 [&_h2]:text-sm [&_h2]:font-semibold [&_h2]:text-slate-900",
        "[&_h3]:mt-3 [&_h3]:mb-1.5 [&_h3]:text-sm [&_h3]:font-semibold [&_h3]:text-slate-900",
        "[&_p]:my-2",
