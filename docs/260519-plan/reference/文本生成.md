...
阿里云百炼提供[北京](https://bailian.console.aliyun.com/?tab=model#/model-market)、[新加坡](https://modelstudio.console.aliyun.com/?tab=doc#/doc/?type=model&url=2840914)、[弗吉尼亚](https://modelstudio.console.aliyun.com/us-east-1?tab=doc#/doc/?type=model&url=2840914)和[法兰克福](https://modelstudio.console.aliyun.com/eu-central-1?tab=doc#/doc/?type=model&url=2840914)地域的模型服务，各地域的API Key不同，选择邻近地域调用可降低网络延迟，详情请参见[选择地域和服务部署范围](https://help.aliyun.com/zh/model-studio/regions/)。
